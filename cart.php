...
if(isset($_POST['delete_all'])){
   ...
   $message[] = 'Pesanan Di Hapus Semua!';
}
...
<div class="heading">
   ...
   <p><a href="index.php">Beranda</a> <span> / cart</span></p>
</div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="sub-total"> Harga : <span>Rp.<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
      </form>
      <?php
